...
namespace CRISPER.Controllers
{
    public class ModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,title,description")] Model model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,title,description")] Model model)
        {
            if (id != model.id)
            {
                return NotFound();
